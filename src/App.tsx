...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-100 to-green-100 flex flex-col items-center justify-center p-4">
      <div className="max-w-4xl w-full bg-white rounded-xl shadow-lg overflow-hidden">
        <div className="p-6 bg-indigo-600 text-white text-center">
          ...
          <p className="text-indigo-200 mt-1">A timeless game, reinvented</p>
        </div>
